...
public class OSMWayTest extends OSMEntityTest {
    ...
    private static final OSMNode TEST_NODE_1 = new OSMNode(12, new PointGeo(
            0.125621, 0.803253), EMPTY_ATTRIBUTES);
    private static final OSMNode TEST_NODE_2 = new OSMNode(34, new PointGeo(
            0.136710, 0.814253), EMPTY_ATTRIBUTES);
    private static final OSMNode TEST_NODE_3 = new OSMNode(56, new PointGeo(
            0.107312, 0.805619), EMPTY_ATTRIBUTES);
    ...
    public void closed() {
        ...
        assertEquals(testWay.nodesCount(), 3);
        assertEquals(testWay.nodes(), testWayList);
        assertEquals(testWay.nonRepeatingNodes(),
                testWayList.subList(0, testWayList.size() - 1));
    }
