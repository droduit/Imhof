...
public class OSMMapTest {
    ...
    public void relationsListNonModifiable () throws Exception {
        ...
        testRelation1Members.add(new OSMRelation.Member(OSMRelation.Member.Type.NODE, "First",
                testNode1));
        testRelation1Members.add(new OSMRelation.Member(OSMRelation.Member.Type.NODE, "Second",
                testNode2));
        testRelation1Members.add(new OSMRelation.Member(OSMRelation.Member.Type.WAY, "Total",
                testWay1));
        ...
        testRelation2Members.add(new OSMRelation.Member(OSMRelation.Member.Type.NODE, "First",
                testNode2));
        testRelation2Members.add(new OSMRelation.Member(OSMRelation.Member.Type.NODE, "Second",
                testNode3));
        testRelation2Members.add(new OSMRelation.Member(OSMRelation.Member.Type.WAY, "Total",
                testWay2));
    ...
    public void testAddRelation () {
        OSMMap.Builder builder = new OSMMap.Builder();
        long id = 5;
        OSMRelation relation = new OSMRelation(id, new ArrayList<Member>(), new Attributes(
    ...
    public void testBuild () {
        ...
        long idRelation = 5;
        OSMRelation relation = new OSMRelation(idRelation, new ArrayList<Member>(), new Attributes(
                sampleAttributesValues()));
        builder.addRelation(relation);
