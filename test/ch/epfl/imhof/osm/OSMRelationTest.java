...
public class OSMRelationTest extends OSMEntityTest {
    ...
    private static final OSMNode TEST_NODE_1 = new OSMNode(78, new PointGeo(0.125621, 0.803253),
            EMPTY_ATTRIBUTES);
    private static final OSMNode TEST_NODE_2 = new OSMNode(91, new PointGeo(0.136710, 0.814253),
            EMPTY_ATTRIBUTES);

    @Override
    OSMEntity newEntity (long id, Attributes entityAttributes) {
        OSMRelation.Member testMember1 = new OSMRelation.Member(OSMRelation.Member.Type.NODE,
                "testPoint1", TEST_NODE_1);
    ...
    public void constructorWithNodeWayRelation () {
        OSMRelation.Member testMember1 = new OSMRelation.Member(OSMRelation.Member.Type.NODE,
                "testPoint1", TEST_NODE_1);
        OSMRelation.Member testMember2 = new OSMRelation.Member(OSMRelation.Member.Type.NODE,
                "testPoint2", TEST_NODE_2);

        List<OSMNode> nodes = Arrays.asList(TEST_NODE_1, TEST_NODE_2);
        OSMWay way = new OSMWay(45, nodes, EMPTY_ATTRIBUTES);
        OSMRelation.Member testMember3 = new OSMRelation.Member(OSMRelation.Member.Type.WAY,
                "testWay", way);

        OSMRelation relation = new OSMRelation(67, Collections.emptyList(), EMPTY_ATTRIBUTES);
        OSMRelation.Member testMember4 = new OSMRelation.Member(OSMRelation.Member.Type.RELATION,
        ...
        assertTrue(ch.epfl.imhof.testUtilities.ListNonMutableTestUtility.nonMutableFieldListTest(
                testMemberList, testEndRelation.members()));
    }
    ...
    public void memberConstructorAndGetType () {
        OSMRelation.Member testMember = new OSMRelation.Member(OSMRelation.Member.Type.NODE,
                "test", TEST_NODE_1);
