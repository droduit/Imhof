...
public abstract class OSMEntityTest {
    ...
    protected static final Attributes EMPTY_ATTRIBUTES = new Attributes(
    ...
    /**
     * Since the method build was not defined in OSMEntity, I used the
     * reflection for this test
     */
