...
public class OSMMapReaderTest {
    ...
    public void joinedBuildings () {
        ...
        try {
            testMapReadResult = OSMMapReader.readOSMFile(
                    getClass().getResource("/OSMtestFiles/testJoinedBuildings.osm").getFile(),
                    false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        ...
        for (int i = 0; i < 2; ++i) {
            ...
            assertEquals("multipolygon",
                    testMapReadResult.relations().get(i).attributes().get("type"));
        }
    }
        ...
        for (int i = 0; i < 2; ++i) {
            ...
            if (testMapReadResult.ways().get(i).attributes().contains("landuse")) {
                assertEquals("residential",
                        testMapReadResult.ways().get(i).attributes().get("landuse"));
                landUseFound = true;
            }
        }
    ...
    public void roads () {
        ...
        try {
            testMapReadResult = OSMMapReader.readOSMFile(
                    getClass().getResource("/OSMtestFiles/testRoads.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
    ...
    public void multipolygons () {
        ...
        try {
            testMapReadResult = OSMMapReader.readOSMFile(
                    getClass().getResource("/OSMtestFiles/testMultipolygons.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
    ...
    public void DataCorrupted () {
        ...
        try {
            testMapReadResult = OSMMapReader.readOSMFile(
                    getClass().getResource("/OSMtestFiles/testDataCorrupted.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
    ...
    public void typeLessRelations () {
        ...
        try {
            testMapReadResult = OSMMapReader.readOSMFile(
                    getClass().getResource("/OSMtestFiles/testTypelessRelations.osm").getFile(),
                    false);
        } catch (Exception e) {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            assertEquals("multipolygon", testMapReadResult.relations().get(i).attributes()
                    .get(attr));
        }
    }
    ...
    public void gzipIsRespected () {
        ...
        try {
            testMapReadResult = OSMMapReader.readOSMFile(
                    getClass().getResource("/OSMtestFiles/testGZip.osm.gz").getFile(), true);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        assertEquals(5, testMapReadResult.ways().size());
    ...
    public void onlyDefinedAttsUsed () {
        ...
        try {
            testMapReadResult = OSMMapReader.readOSMFile(
                    getClass().getResource("/OSMtestFiles/testUndefinedAtts.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        assertEquals(4, testMapReadResult.ways().size());
    ...
    public void learningCenter () {
        try {
            OSMMapReader.readOSMFile(getClass().getResource("/OSMtestFiles/lc.osm.gz").getFile(),
                    true);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
    ...
    public void errorInFile () throws Exception {
        OSMMapReader.readOSMFile(getClass()
                .getResource("/OSMtestFiles/testSimpleBuildingError.osm").getFile(), false);
    }
