...
public class PolygonTest {
    ...
    public void shellGetterReturnsShell() {
        ClosedPolyLine s = new ClosedPolyLine(Arrays.asList(new Point(36, 54),
                new Point(193, -61), new Point(-70, -231), new Point(-634, 96),
                new Point(36, 54)));
    ...
    public void constructorWithoutHolesDoesNotCreateHoles() {
        ClosedPolyLine s = new ClosedPolyLine(Arrays.asList(new Point(0, 0),
    ...
    public void holeListIsClonedBeforeBeingStored() {
        ClosedPolyLine s = new ClosedPolyLine(Arrays.asList(new Point(36, 54),
                new Point(193, -61), new Point(-70, -231), new Point(-634, 96),
                new Point(36, 54)));
        ClosedPolyLine h1 = new ClosedPolyLine(Arrays.asList(new Point(20, 34),
                new Point(0, -31), new Point(-40, -51), new Point(20, 34)));
        ClosedPolyLine h2 = new ClosedPolyLine(Arrays.asList(new Point(27, 44),
                new Point(63, -41), new Point(-5, 0), new Point(27, 44)));
    ...
    public void holesGetterReturnsUnmodifiableList() {
        ...
        ClosedPolyLine l1 = new ClosedPolyLine(Arrays.asList(new Point(1, 1),
                new Point(1, 2), new Point(2, 2)));
        ClosedPolyLine l2 = new ClosedPolyLine(Arrays.asList(new Point(5, 5),
