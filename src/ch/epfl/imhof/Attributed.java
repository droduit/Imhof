 ...
 *
 * @param <T> Type de l'objet value auquel on va attacher les attributs passés en arguments dans le constructeur.
 */
public final class Attributed<T> {
     ...
     * @param value Objet auquel on attache les attributs
     * @param attributes Attributs attachés à l'objet value
     */
     ...
     * @param attributeName Nom de l'attribut dont on veut contrôler l'existence dans la liste des attributs.
     ...
     * @param attributeName Nom de l'attribut à récupérer
    ...
    /**
     * Retourne la valeur associée à l'attribut donné,
     * ou la valeur par défaut donnée si celui-ci n'existe pas.
     * 
     * Correspond à l'une des méthodes get de la classe Attributes.
     * @param attributeName Nom de l'attribut à récupérer
     * @param defaultValue Valeur par défaut de l'attribut si aucune valeur ne lui est associée
     * @return Valeur correspondant au nom de l'attribut passé en argument
     */
    ...
    /**
     * Retourne la valeur entière associée à l'attribut donné,
     * ou la valeur par défaut si celui-ci n'existe pas ou si la valeur
     * qui lui est associée n'est pas un entier valide.
     * 
     * Correspond à l'une des méthodes get de la classe Attributes.
     * @param attributeName Nom de l'attribut à récupérer
     * @param defaultValue Valeur par défaut de l'attribut si aucune valeur ne lui est associée ou si la valeur n'est pas un entier valide
     * @return Valeur correspondant au nom de l'attribut passé en argument
     */
