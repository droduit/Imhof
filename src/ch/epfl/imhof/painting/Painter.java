...
public interface Painter {
     ...
     * carte qu'il reçoit avec la couleur spécifiée
     * 
     * @param color
     *            Couleur de remplissage des polygones
    ...
    /**
     * Retourne un peintre dessinant toutes les lignes de la carte qu'on lui
     * fournis avec le style correspondant
     * 
     * @param lc
     *            Type de terminaison
     * @param lj
     ...
     * @return Peintre de base (cf. description de la méthode)
     */
    public static Painter line(LineCap lc, LineJoin lj, Color color,
            float width, float[] dashed) {
        return line(new LineStyle(lc, lj, color, width, dashed));
    }

    /**
     * Retourne un peintre dessinant toutes les lignes de la carte qu'on lui
     * fournis avec le style correpondant
     * 
     * @param width
     *            Largeur des traits
     * @param color
     ...
     * de tous les polygons de la carte avec le style donné
     * 
     * @param style
     *            Style de traits
     * @return Peintre de base (cf. description de la méthode)
     ...
     * @return Peintre de base (cf. description de la méthode)
     */
    public static Painter outline(LineCap lc, LineJoin lj, Color color,
            float width, float[] dashed) {
    ...
    /**
     * Retourne un peintre se comportant comme celui auquel on l'applique, si ce
     * n'est qu'il ne considère que les éléments de la carte satisfaisant le
     * prédicat.
     * 
     * @param p
     *            Prédicat dont les éléments qui sont satisfaits sont ajouté à
     *            la carte
     * @return Peintre de base (cf. description de la méthode)
     */
    ...
    /**
     * Retourne un peintre dessinant d'abord la carte produite par le 2e peintre
     * pris en argument puis, par dessus, la carte produite par le premier
     * peintre.
     * 
     * @param p
     *            2e peintre
    ...
    /**
     * Retourne un peintre utilisant l'attribut layer attaché aux entités de la
     * carte pour la dessiner par couches, càd en dessinant d'abord toutes les
     * entités de la couche -5, -4 et ainsi de suite jusqu'à la couche +5
     * 
     * @return Peintre de base (cf. description de la méthode)
     */
    public default Painter layered() {
        return (map, canvas) -> {
            IntStream.iterate(5, i -> i - 1).limit(11)
