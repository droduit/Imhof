...
public final class Color {
    ...
    /**
     * Construit une nouvelle couleur à l'aide des trois composantes rouges
     * vertes et bleues qui doivent etre dans l'intervalle [0;1]
     * 
     * @param r
     *            Composante Rouge
     * @param g
     ...
     * 
     * @param v
     *            Composante définissant le niveau de gris
     ...
     * 
     * @param rgb
     *            Composantes "empaquetées" contenant les 3 composantes
     *            indifiduelles
    ...
    /**
     * Contrôle de la validité des composantes de la couleur qui doivent être
     * dans une plage de [0;1]
     * 
     * @param p
