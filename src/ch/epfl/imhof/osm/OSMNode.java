...
public final class OSMNode extends OSMEntity {
     ...
     * 
     * @param id
     *            Identifiant unique associé au noeud
     * @param position
    ...
    /**
     * Sert de bâtisseur à la classe OSMNode et permet de construire un nœud en
     * plusieurs étapes
     * 
     * @author Thierry Treyer (235116)
     * @author Dominique Roduit (234868)
    ...
    public final static class Builder extends OSMEntity.Builder {
         ...
         * 
         * @param id
         *            Identifiant unique attaché au noeud
         * @param position
         *            Position géographique du noeud
         */
         ...
         * bâtisseur.
         * 
         * @return Noeud construit sur la base des informatoins ajoutés
