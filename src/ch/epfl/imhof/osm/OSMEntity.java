...
public abstract class OSMEntity {
    ...
    public static abstract class Builder {
         ...
         * @param id L'identifiant unique associé à l'entité
         */
     ...
     * @param id Identifiant unique pour l'entité
     * @param attributes Attributs attachés à l'entité
     * @throws NullPointerException Lorsque l'objet contenant les attribut est null
     */
    public OSMEntity(long id, Attributes attributes) {
        if(attributes==null)
            throw new NullPointerException("L'objet attributes ne doit pas être null");
     ...
     * @param key Clé correspondant a l'attribut
     ...
     * @param key Clé de l'attribut dont on veut la valeur
