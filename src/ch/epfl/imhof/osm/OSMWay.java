...
public final class OSMWay extends OSMEntity {
    ...
    public static final class Builder extends OSMEntity.Builder {
         ...
         * @param id Identifiant unique du chemin en construction
         */
         ...
         * @param newNode Nouveau noeud a ajouter a la liste pour le chemin
         */
        public void addNode(OSMNode newNode) {
            this.nodes.add(newNode);
        }
        /**
         * permet de déterminer si la construction du chemin est incomplète ou non.
        ...
        * Lève l'exception IllegalStateException si le chemin en cours de construction est incomplet.
        ...
        */
        public OSMWay build() {
            if(isIncomplete()) 
                throw new IllegalStateException("La liste des noeuds doit etre >= 2 sinon ce n'est pas un chemin !");
     ...
     * @param id Identifiant unique attribué au chemin
     * @param nodes Liste de noeuds représentant le chemin
     * @param attributes Attributs attachés au chemin
     * @throws IllegalArgumentException Si la liste des noeuds composants le chemin contient moins de 2 noeuds
     */
    public OSMWay(long id, List<OSMNode> nodes, Attributes attributes) {
        super(id, attributes);
        
        if(nodes.size()<2)
            throw new IllegalArgumentException("La liste des noeuds doit contenir au minimum 2 noeuds");
        
        this.nodes = Collections.unmodifiableList(new ArrayList<>(nodes));
        this.attributes = Objects.requireNonNull(attributes, "L'objet contenant les attributs ne doit pas etre null");
    }
    /**
    ...
    * @return Liste des noeuds du chemin sans le dernier si celui-ci est identique au premier
    */
    ...
    /**
     * Retourne vrai ssi le chemin est fermé, c-à-d que son premier nœud est identique à son dernier nœud.
