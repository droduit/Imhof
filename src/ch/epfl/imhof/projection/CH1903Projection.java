...
/**
 * Implémentation de la projection CH1903, adaptée pour fonctionner
 * avec des coordonnées WGS84.
 * Cette projection utilise les formules de projection de Mercator,
...
public final class CH1903Projection implements Projection {
    public Point project (PointGeo pg) {
        ...
        double x = 600072.37 + 211455.93 * lon1 - 10938.51 * lon1 * lat1 - 0.36 * lon1 * lat2 - 44.54 * lon3;
        double y = 200147.07 + 308807.95 * lat1 + 3745.25 * lon2 + 76.63 * lat2 - 194.56 * lon2 * lat1 + 119.79 * lat3;
    ...
    public PointGeo inverse (Point p) {
        ...
        double lon0 = 2.6779094 + 4.728982 * x1 + 0.791484 * x1 * y1 + 0.1306 * x1 * y2 - 0.0436 * x3;
        double lat0 = 16.9023892 + 3.238272 * y1 - 0.270978 * x2 - 0.002528 * y2 - 0.0447 * x2 * y1 - 0.0140 * y3;
