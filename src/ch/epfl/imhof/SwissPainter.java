 ...
 * Ce fichier étant fournis, il n'a pas été commenté.
 *
...
public final class SwissPainter {
    ...
    static {
        ...
        Painter fgPainter =
                roadPainter
                .above(line(LineCap.Round, LineJoin.Miter, darkGray, 0.5f, new float[]{1f, 2f}).when(tagged("highway", "footway", "steps", "path", "track", "cycleway")))
