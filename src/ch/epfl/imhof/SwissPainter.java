...
/**
 * Représente un peintre pour les cartes suisses. Ce fichier étant fournis, il
...
public final class SwissPainter {
    ...
    static {
        ...
        Painter roadPainter = RoadPainterGenerator.painterForRoads(
                new RoadSpec(tagged("highway", "motorway", "trunk"), 2f,
                        orange, 0.5f, black),
        ...
        Painter fgPainter = roadPainter
                .above(line(LineCap.Round, LineJoin.Miter, darkGray, 0.5f,
                        new float[] { 1f, 2f }).when(
