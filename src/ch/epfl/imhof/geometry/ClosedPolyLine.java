 ...
 * points étants reliés, la ligne dessine alors une forme fermée.
 *
...
public final class ClosedPolyLine extends PolyLine {
    ...
    /**
     * Normalise la valeur de l'index donné pour qu'il corresponde à l'index
     * d'un sommet de la PolyLine.
     *
     * @param index
     *            L'index à normaliser, ayant une valeur dans |R
     *
    ...
    /**
     * Détermine si le point p se trouve à gauche de la droite formée par les
     * points l1 et l2.
     *
     * @param l1
     *            Le premier point de la droite
     * @param l2
     *            Le second point de la droite
     * @param p
     *            Le point que l'on veut situer par rapport à la droite
     *
